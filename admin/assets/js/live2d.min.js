...
function(t) {
	...
	default),
		...
		X = .5;
	window.loadlive2d = L;
	window.live2d_setExpression = function(t, i) {
		var e = R.getModel(0);
		if (e) e.setExpression(i)
	};
	window.live2d_resetExpression = function(t) {
		var i = R.getModel(0);
		if (i) i.expressionManager && i.expressionManager.stopAllMotions()
	};
	window.live2d_getExpressions = function(t) {
		var i = R.getModel(0);
		if (i && i.expressions) {
			var e = [];
			for (var r in i.expressions) e.push(r);
			return e
		}
		return []
	}
